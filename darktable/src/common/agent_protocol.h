...
#define DT_AGENT_CHAT_DEFAULT_SERVER_HOST "127.0.0.1"
#define DT_AGENT_CHAT_DEFAULT_SERVER_PORT 8001
#define DT_AGENT_CHAT_DEFAULT_SERVER_URL_BASE "http://127.0.0.1:8001"
